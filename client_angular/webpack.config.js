...
module.exports = {
    entry: {
        'polyfills_angular': './app/polyfills.ts',
        'vendor_angular': './app/vendor.ts',
        'app_angular': './app/main.ts'
    },
    ...
    plugins: [
        ...
        new webpack.optimize.CommonsChunkPlugin({
            name: ['app_angular', 'vendor_angular', 'polyfills_angular']
        }),
